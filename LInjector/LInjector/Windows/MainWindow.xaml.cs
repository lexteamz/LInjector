...
namespace LInjector.Windows
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            var liWindowState = Shared.mainWindow!.WindowState;
            Shared.mainView!.Margin = liWindowState == WindowState.Maximized
                ? new Thickness(0)
                : new Thickness(25);

            wChromeShell.ResizeBorderThickness = liWindowState == WindowState.Maximized
                ? new Thickness(0)
                : new Thickness(25);
        }
    }
